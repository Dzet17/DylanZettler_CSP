...
//  DylanZettler_CSP
//
//  Created by Zettler, Dylan on 12/5/17.
...
class DrawingView: UIView
{
    ...
    public func drawHappyTree() -> Void
    {
        ...
        bobRoss.close()
        UIColor(patternImage: UIImage(named: "true")!).setFill()
        ...
        bobRoss.move(to: CGPoint(x:110, y:150))
        bobRoss.addLine(to: CGPoint(x:150, y:200))
        bobRoss.addLine(to: CGPoint(x:10, y:200))
        bobRoss.addLine(to: CGPoint(x:50, y:150))
        happyTree.close()
        happyTree.stroke()
        happyTree.fill()
        bobRoss.move(to: CGPoint(x:80, y:200))
        bobRoss.addLine(to: CGPoint(x:80, y:250))
